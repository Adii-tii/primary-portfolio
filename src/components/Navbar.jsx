...
import resume from "../assets/resume.pdf"; // make sure extension matches
    ...
    <nav className="fixed top-6 w-full z-50 flex justify-center px-4">
      <div className="flex items-center gap-4 sm:gap-6 rounded-2xl border-2 border-[#1E1E1E] px-4 md:px-6 py-3 shadow-[4px_4px_0px_#1E1E1E] bg-[#FFFFEB] transition-all">
        ...
        <div className="flex items-center gap-3">
          <a
            href={resume}
            download="Aditi_Resume"
            className="hidden sm:flex px-4 py-2 border-2 border-[#1E1E1E] rounded-xl text-sm font-bold text-[#1E1E1E] hover:bg-[#1E1E1E] hover:text-[#FFFFEB] transition-colors"
          >
            Resume
          </a>
